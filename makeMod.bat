@echo off
set modname=promodlive220_flags_raw
set COMPILEDIR=%CD%
color 11
title "PROMODLIVE 220 RAW + FLAGS"
:MAKEOPTIONS
cls
:MAKEOPTIONS
echo -----------------------------------------------------------------
...
echo -----------------------------------------------------------------
echo.
echo  Building promodlive220.iwd:
del promodlive220.iwd
del z_custom_ruleset.iwd
7za a -r -tzip promodlive220.iwd images
7za a -r -tzip promodlive220.iwd sound
7za a -r -tzip promodlive220.iwd weapons
