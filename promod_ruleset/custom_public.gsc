main()
{
	...
	{
		setDvar( "class_assault_limit", 6 );
		setDvar( "class_specops_limit", 6 );
		setDvar( "class_demolitions_limit", 4 );
	...
	setDvar( "promod_mc_message_1", "^5Developer^0'^5s^0: ^5CWP-Razor^0, ^5Night^0, ^5JEENNN" );
	setDvar( "promod_mc_message_2", "^5Menu ^0& ^5Material^0'^5s^0: ^5Night^0, ^5ZaGGoreC" );
